...
export const TerminalChallenge: React.FC<TerminalChallengeProps> = ({ onBack }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-cyber font-bold mb-4 cyber-glow flex items-center justify-center gap-3">
      ...
      <Card className="cyber-bg border-primary/30">
        ...
        <CardContent>
          <div 
            className="bg-black/90 rounded-lg p-4 font-mono text-sm min-h-[400px] max-h-[400px] overflow-y-auto"
